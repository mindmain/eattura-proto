...
- Chiarite conseguenze superamento dimensione massima per supporti SFTP (pag.14).
...
- PEC del SdI (codice di errore 00330) (paragrafi modificati: 2.1.1 - 2.1.2 - 2.1.4 - Appendice 1)
...
- Introdotti nuovi controlli sui dati fattura con codici 00321, 00325 e 00448. (paragrafi modificati: 2.1.2 - 2.1.7 – 2.1.8 – 2.2.9.1 – 2.2.10.1
- – 2.2.10.2 – 2.2.12 - 4.2.1.2.2 – 4.2.1.3.2 – Appendice 1 –
...
consegna della fattura. Questa data è individuata, sulla base del canale di trasmissione, come specificato nel successivo paragrafo 1.7. Per quanto descritto nel paragrafo citato, il processo di consegna della fattura può influenzare i tempi di consegna della ricevuta per cause non dipendenti dal
SdI.
...
1.2.2 lett. b), (es.: ITAAABBB99T99X999W_00001.zip ) e non è possibile accedere al suo contenuto perché “corrotto”, il nome del file con il quale il
